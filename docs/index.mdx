...
icon: "house"
description: "High-performance live line and candlestick charts for React Native, built on TGFX and Reanimated."
---
...
It's built on [`react-native-tgfx`](https://www.npmjs.com/package/react-native-tgfx),
...
<Frame caption="Every overlay, toggled live in the example app's Playground">
  <video autoPlay loop muted playsInline controls poster="/media/playground.jpg" src="/media/playground.mp4" />
</Frame>
...
<Note>
  ...
  Native on TGFX and Reanimated. This is not a fork; see the project
