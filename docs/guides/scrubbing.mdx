...
<Frame caption="Scrub a crosshair across history">
  <video autoPlay loop muted playsInline controls poster="/media/scrubbing.jpg" src="/media/scrubbing.mp4" />
</Frame>
...
For full control, pass a `component` — a TGFX dot that receives the scrub position as
